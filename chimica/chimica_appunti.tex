...
Esempi:
\begin{enumerate}
    \item \ce{Ca(OH)2 + H2SO4 -> **CaSO4 + H2O} **solfato di calcio
    \item \ce{NaOH + ClO -> **NaCIO + H2O} **ipoclorito di sodio
    \item \ce{3 CuOh + H3Po4 -> **Cu3 PO4 + 3H2O} **fosfato rameoso
    \item \ce{3 Cu(OH)2 + 2 H3PO4 = **Cu3(PO4)2 + 6 H2O} **fosfato rameico
\end{enumerate}
...
\subsubsection{Nomenclatura Tradizionale}
Quando rimane un atomo di idrogeno, questo va indicato dal nome. Al nome dell'anione si aggiunge un prefisso "idrogeno-", e davanti all'idrogeno, se c'è più di uno si aggiunge "di-". Per esempio c'è \ce{Ca(HSO4)2} che si chiama idrogenosolfato di calcio. 

Per i sali acidi derivanti da \ce{H2CO3, H2SO3, H2SO4}, per uso commerciale sono accettati i prefissi "bi-", come \ce{Ca(HCO3)2} si può chiamare bicarbonato di calcio. 
...
\begin{enumerate}
    \item \ce{K2SO3} triossosolfato (IV) di dipotassio
    \item \ce{K2SO4} tetraossosolfato(VI) di dipotassio
    \item \ce{Na2HPO3} triossofosfato(III) di disodio
    \item \ce{Al2(CO3)3} tritriossocarbonato(IV) di dialluminio
\end{enumerate}
...
\begin{enumerate}
    \item \ce{K2SO4 * 2H2O} solfato di potassio diidrato
    \item \ce{Ca(NO3)2 * 4H2O} nitrato di calcio tetraidratoe
\end{enumerate} 
...
I cationi monoatomici sono chiamati come l'elemento corrispondente. Esempio: \ce{Zn2+} ione zinco (II). 

I cationi ottenuti per addizione di un protone agli idruri prendono il nome con la termiazione -onio. Esempio: \ce{H3O+} ione ossonio (idrossonio), \ce{NH4+} ione ammonio

Gli anioni monoatomici prendono la desinenza in "-uro" ad eccezione dello ione ossido \ce{O2-} Esempio: \ce{H-} idruro \ce{F-} fluoruro

Hanno terminazione in -uro anche alcuni nomi di anioni poliatomici con eccezzione degli anioni idrossido \ce{OH-}, perossido \ce{O_2^2+}, superossido. 
